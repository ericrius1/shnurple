...
.controller('myListCtrl', function($rootScope, $scope, $window, $ionicModal, $firebase) {
    ...
    $scope.list = [];
    var shnurpleRef = new Firebase($rootScope.baseUrl + escapeEmailAddress($rootScope.userEmail));
    shnurpleRef.on('value', function(snapshot) {
    ...
    $scope.deleteItem = function(key) {
        ...
        shnurpleRef.child(key).remove(function(error) {
            if (error) {
                $rootScope.hide();
                $rootScope.notify('Oops! something went wrong. Try again later');
            } else {
